...
const VoiceAgents: React.FC = () => {
  return (
      <div className='h-[100%] md:w-[50%] flex flex-col md:justify-start md:items-start justify-center items-center gap-2 pl-2 md:border-r border-b border-[#262626] pt-4 py-4 md:py-0'>
          <h1 className='text-white text-[20px] md:text-[24px]  md:my-2'> Voice AI Agents </h1>
          <p className='text-[14px] md:text-[16px] text-[#A3A3A3] pr-8 md:my-2 md:text-left text-center'>Build and deploy low cost voice AI agents that talk and take actions like humans </p>
