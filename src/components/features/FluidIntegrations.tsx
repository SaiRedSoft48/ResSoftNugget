...
const FluidIntegrations: React.FC = () => {
    ...
    return (
        <div className=' h-[100%] md:w-[50%] p-4 flex flex-col justify-center items-center md:justify-start md:items-start gap-3'>
            <h1 className='text-white text-[20px] md:text-[24px]'> Fluid Integrations </h1>
            <p className='text-[14px] md:text-[14px] text-center md:text-left text-[#A3A3A3] pr-4'>Integrate seamlessly with tools like Freshdesk, Zoho, and more </p>
