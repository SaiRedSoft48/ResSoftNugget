...
const IntelligentConversations: React.FC = () => {
  ...
  return (
      <div className='h-[100%] flex flex-col justify-center items-center md:justify-start md:items-start gap-3 border-b border-[#262626]'>
          <h1 className='text-white text-center md:text-left text-[20px] md:text-[24px] pl-3'> Intelligent Conversations. Effortless Support </h1>
          <p className='text-[#A3A3A3] pl-3 text-center md:text-left text-[14px] md:text-[16px]'>Seamlessly integrate data sources and SOPs to generate accurate responses and actions </p>
